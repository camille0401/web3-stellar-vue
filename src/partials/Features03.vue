            ...
            <Highlighter class="group">
              <HighlighterItem>
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <img :src="$t('home.home-index-03')" width="768" height="400" alt="Feature 04">
                </div>
              </HighlighterItem>
            </Highlighter>
          </div>
