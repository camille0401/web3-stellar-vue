        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <div>
            <div
              ...
              {{ $t("home.testimonialsCarousel_tips") }}</div>
          </div>
          <h2
            class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
            {{ $t("home.testimonialsCarousel_title") }}</h2>
          <p class="text-lg text-slate-400">{{ $t("home.testimonialsCarousel_desc") }}</p>
        </div>

        <!-- Carousel built with Swiper.js [https://swiperjs.com/] -->
        <!-- * Custom styles in src/css/additional-styles/theme.scss -->
        <div
          class="relative before:absolute before:inset-0 before:-translate-x-full before:z-20 before:bg-linear-to-l before:from-transparent before:to-slate-900 before:to-20% after:absolute after:inset-0 after:translate-x-full after:z-20 after:bg-linear-to-r after:from-transparent after:to-slate-900 after:to-20%">
              ...
              <HighlighterItem class="swiper-slide h-auto group/slide">
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div class="flex flex-col p-6 h-full">
                    ...
                    <div class="grow">
                      <div class="font-bold text-lg mb-1"> {{ $t("home.testimonialsCarousel_card_title") }} </div>
                      <div class="text-slate-400 mb-3"> {{ $t("home.testimonialsCarousel_card_desc") }} </div>
                    </div>
                  </div>
                </div>
              </HighlighterItem>
              <HighlighterItem class="swiper-slide h-auto group/slide">
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div class="flex flex-col p-6 h-full">
                    ...
                    <div class="font-bold text-lg mb-1">{{ $t("home.testimonialsCarousel_card01_title") }}</div>
                    <div class="text-slate-400 mb-3">{{ $t("home.testimonialsCarousel_card01_desc") }}</div>
                  </div>
                </div>
              </HighlighterItem>
              <HighlighterItem class="swiper-slide h-auto group/slide">
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div class="flex flex-col p-6 h-full">
                    ...
                    <div class="grow">
                      <div class="font-bold text-lg mb-1">{{ $t("home.testimonialsCarousel_card02_title") }}</div>
                      <div class="text-slate-400 mb-3">{{ $t("home.testimonialsCarousel_card02_desc") }}</div>
                    </div>
              ...
              <HighlighterItem class="swiper-slide h-auto group/slide">
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div class="flex flex-col p-6 h-full">
                    ...
                    <div class="grow">
                      <div class="font-bold text-lg mb-1">{{ $t("home.testimonialsCarousel_card03_title") }}</div>
                      <div class="text-slate-400 mb-3">{{ $t("home.testimonialsCarousel_card03_desc") }} </div>
                    </div>
              ...
              <HighlighterItem class="swiper-slide h-auto group/slide">
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div class="flex flex-col p-6 h-full">
                    ...
                    <div class="grow">
                      <div class="font-bold text-lg mb-1">{{ $t("home.testimonialsCarousel_card04_title") }}</div>
                      <div class="text-slate-400 mb-3">{{ $t("home.testimonialsCarousel_card04_desc") }}</div>
                    </div>
